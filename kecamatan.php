...
<head>
    ...
    <title>Dashboard Demografi - Kecamatan</title>
    ...
    <script src="assets/js/kecamatan.js" defer></script>
</head>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="kecamatan.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="kelurahan.php" id="kelurahanLink">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative border-radius-lg">
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder mb-0">Dashboard Demografi Kecamatan</h6>
                </nav>
            </div>
        </nav>
        <div class="container-fluid py-4">
            ...
            <div class="container mt-5">
                ...
                <h1 class="text-center">Dashboard Demografi Kecamatan</h1>
                ...
                <div id="dataSection" style="display: none;">
                    <h2 id="selectedKecamatan" class="text-center"></h2>
                    ...
                    <!-- Button: Navigate to Kelurahan -->
                    <div class="text-center mb-5">
                        <button id="toKelurahan" class="btn btn-primary" style="display: none;">
